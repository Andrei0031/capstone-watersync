 ...
 */
function checkClientForDisconnectionNotices($client_id) {
    global $conn;
    $notices_needed = [];
 ...
 */
function getAllClientsNeedingNotices() {
    global $conn;
    
    // Get all clients with overdue bills
    ...
    while ($client = $result->fetch_assoc()) {
        $notices_needed = checkClientForDisconnectionNotices($client['id']);
 ...
 */
function autoGenerateDisconnectionNotices($admin_id) {
    $clients = getAllClientsNeedingNotices();
    $generated_count = 0;
