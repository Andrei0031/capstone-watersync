                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="client_notices.php" style="position: relative;">
                            ...
                            <span id="navbar-notification-badge" class="badge bg-danger" style="display: <?php echo $notification_count > 0 ? 'flex' : 'none'; ?>; position: absolute; top: -4px; right: -8px; font-size: 0.65rem; border-radius: 10px; padding: 2px 6px;"><?php echo $notification_count > 99 ? '99+' : intval($notification_count); ?></span>
                        </a>
                    </li>
                    <li class="nav-item">
